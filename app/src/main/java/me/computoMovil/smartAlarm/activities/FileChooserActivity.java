...
public class FileChooserActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_TYPE = "james.smartAlarm.FileChooserActivity.EXTRA_TYPE";
    public static final String EXTRA_PREFERENCE = "james.smartAlarm.FileChooserActivity.EXTRA_PREFERENCE";
